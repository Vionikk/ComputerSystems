...
namespace Lab1EncodeBase64
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string pathToWrite = @"C:\Users\vlady\OneDrive\Desktop\Computer systems\Lab1\EncryptText\";
            string pathToCmprssed = @"C:\Users\vlady\OneDrive\Desktop\Computer systems\Lab1\EncryptText\";
            ...
            try
            {
                ...
                Console.WriteLine(".tar(base64 + bz2):");
                pathToCmprssed += compressedFile + ".tar.bz2";
